...
function App() {
  const stripePromise = loadStripe("pk_test_51Ot9QVSB7rTzC7LD6kyEoY051w2Cd0oOGOCjzcyj0RuP4CupEeDuM8zsID0npWeBahb60jYVwLyjTbkzRSHSs3a4005FpcLgpb");
  ...
  return (
  <div className="App">
    {/* This ensures that the rounting functionality is available throughout the application */}
